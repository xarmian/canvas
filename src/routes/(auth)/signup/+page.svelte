...
<style>
	 ...
	 * header above and `min-height: 100vh` on the shell. The signup
	 * card fills the remaining viewport via `flex: 1` and centers
	 * itself inside that space — replaces the pre-BT-155 standalone
